...
export function getStudentById(http: HttpClient, rootUrl: string, params: GetStudentById$Params, context?: HttpContext): Observable<StrictHttpResponse<StudentDtoToReturn>> {
